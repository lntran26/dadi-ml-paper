...
# input_fname = 'data/test_100_theta_1000_ns200'
# output_fname = 'data/projected_test_100_theta_1000_ns200'
# projected_size = (160,160)
# input_fname = 'data/test_100_theta_100_ns39'
# output_fname = 'data/projected_test_100_theta_100_ns39'
# projected_size = (20,20)
# input_fname = 'data/test_100_theta_100_ns200'
# output_fname = 'data/projected_test_100_theta_100_ns200'
# projected_size = (160,160)
# input_fname = 'data/test_1000_theta_100_ns39'
# output_fname = 'data/projected_test_1000_theta_100_ns39'
# projected_size = (20,20)
